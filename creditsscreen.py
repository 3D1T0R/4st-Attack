...
class CreditsScreen:
	def __init__(self, surface, images, locations):
		...
		background = pygame.image.load("themes/clean/1024x768/background.png").convert_alpha()
		programming = pygame.image.load("credits/1024/programming.png").convert_alpha()
		graphics = pygame.image.load("credits/1024/graphics.png").convert_alpha()
		thanks = pygame.image.load("credits/1024/thanks.png").convert_alpha()
		#pygame_image = pygame.image.load("credits/1024/pygame.png").convert_alpha()
		slm = pygame.image.load("credits/1024/slm.png").convert_alpha()
		chakie = pygame.image.load("credits/1024/chakie.png").convert_alpha()
		korruptor = pygame.image.load("credits/1024/korruptor.png").convert_alpha()
